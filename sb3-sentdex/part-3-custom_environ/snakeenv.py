...
class SnakeEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.observation_space = spaces.Box(low=-500, high=500,
                                    shape=(N_CHANNELS5+SNAKE_LEN_GOAL,), dtype=np.float32) # float32 is default data type for np arrays.
    ...
    def step(self, action):
        ...
        # observation: head_x, head_y, apple_delta_x, apple_delta_y, score, snake_length, previous_modes
        ...
        self.observations = [head_x, head_y, apple_delta_x, apple_delta_y, snake_length] + list(self.prev_actions)

        self.observation = np.array(self.observations, dtype=np.float32)
        info = {}
